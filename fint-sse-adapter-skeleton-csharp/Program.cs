...
using fint_sse_adapter_skeleton_csharp.Adapter;
using fint_sse_adapter_skeleton_csharp.Adapter.service;
using fint_sse_adapter_skeleton_csharp.Adapter.sse;
using fint_sse_adapter_skeleton_csharp.Customcode.Service;
using Serilog;
using System;
using System.Collections.Generic;

namespace fint_sse_adapter_skeleton_csharp
{
    class Program
    {
